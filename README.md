...
1. **Study the Theory:** Read notes, understand the pointer behaviors (e.g., [Theory.md]), and write down the generic templates.

2. **Implement Core Scenarios:** Write clean C++ implementations for the base cases (such as [1_single.cpp].)

3. **Practice and Repeat:** Do similar problems and repeat for muscle memory.
